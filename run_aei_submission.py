...
class AEISubmissionCommand:
    def run(self) -> None:
        ...
        if args.verify:
            ...
            store.build(Path("paper/manuscript_source.json"), Path("paper/aei_submission_source.json"), Path("literature/aei_closest_methods.json"), Path("paper/generated-v5"), args.output)

...
def mesh_polygon(points_mm: Sequence[tuple[float, float]], thickness_mm: float, max_element_size_mm: float) -> TriangularMesh:
    ...
    with tempfile.TemporaryDirectory(prefix="gearrl-gmsh-") as directory:
        ...
        geometry_path.write_text(_geo_script(points_mm, max_element_size_mm))

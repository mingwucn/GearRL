...
paper-verify:
	$(PYTHON) run_publication_artifacts.py --verify paper/generated-v4
	$(PYTHON) run_literature_matrix.py --verify paper/literature-v3
	$(PYTHON) run_manuscript.py --verify paper/manuscript-v4
	$(PYTHON) run_submission_readiness.py --verify paper/submission-readiness-v3
	$(PYTHON) run_aei_submission.py --verify paper/aei-submission-v4
...
evidence-verify:
	...
	$(PYTHON) run_planetary_baseline.py --verify data/results/planetary-baseline-v2

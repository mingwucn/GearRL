...
\small
\begin{tabular}{llllllll}
\textbf{Shaft tolerance (mm)} & \textbf{0} & \textbf{0.0005} & \textbf{0.001} & \textbf{0.002} & \textbf{0.005} & \textbf{0.01} & \textbf{0.02} \\
\hline
...
\begin{figure}[htbp]
\centering
\includesvg[inkscapelatex=false,width=\linewidth]{Figure_4.svg}
\caption{Conditional modeled-valid probability across transverse-backlash allowances and uniform shaft-location tolerances at zero housing-clearance erosion. Probabilities are digital-model outcomes, not measured manufacturing yield.}
\end{figure}
\section{Discussion}

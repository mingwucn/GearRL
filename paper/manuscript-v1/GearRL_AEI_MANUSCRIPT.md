...
Prior work already establishes knowledge-graph-driven architecture generation, graph-based transmission configuration synthesis, constrained simulation optimization, automated gearbox sizing, and learning-guided combinatorial design. Therefore, graph use, optimization, and simulation coupling are not claimed as novel individually. Within the audited closest-method set, the unresolved combination is a solver-hidden requirements benchmark, executable gear-domain knowledge, independent positive certificates and complete negative proofs, strength-coupled admission, and hash-bound reporting in one workflow.
...
The closest-method audit covers explicit engineering-knowledge formalization, constraint-based design with simulation, gear and transmission synthesis, and constrained learning. The resulting contribution claim is an inference limited to this audited set, not a universal priority claim.

Knowledge-driven product architecture and industrial robot design demonstrate that graphs can connect requirements, topology, components, simulation, and CAD. Gearbox automation and recent planetary-gear optimization provide substantially broader component and durability analysis than the present bounded planar family. Conversely, common four-variable gear-ratio benchmarks omit enclosure geometry, independent certification, and negative proofs. GearRL targets the evidential integration between these areas rather than replacing their domain breadth.
...
**Registered table: `cae-verification`**
...
**Registered table: `strength-coupling`**
